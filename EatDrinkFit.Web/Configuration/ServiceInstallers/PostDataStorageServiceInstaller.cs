...
// File: Configuration/ServiceInstallers/PostDataStorageServiceInstaller.cs
...
{
    public class PostDataStorageServiceInstaller : IServiceInstaller
    {
        public void Install(IServiceCollection services, IConfiguration configuration)
        {
            services.AddScoped<IPostDataStorageService, PostDataStorageService>();
        }
    }
}
