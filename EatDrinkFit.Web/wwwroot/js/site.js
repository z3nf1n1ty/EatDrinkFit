...
function dashboardPercentCaloriesChart(inputLables, inputOtherData, inputFatData, inputCarbData, inputProteinData) {
    const data = {
        labels: inputLables,
        datasets: [{
            label: 'Other',
    ...
    // render init block
    const myChart = new Chart(
        document.getElementById('PercentCaloriesChart'),
        config
    );
